...
class StaffController extends Controller
{
    ...
    {
        $staff = Staff::orderBy('sort_order')->orderBy('id')->get();
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.staff.index')->with('status', 'Personal creado.');
    }
    ...
    public function update(Request $request, Staff $staff)
    {
        ...
        return redirect()->route('admin.staff.index')->with('status', 'Personal actualizado.');
    }
    ...
    public function destroy(Staff $staff)
    {
        ...
        return redirect()->route('admin.staff.index')->with('status', 'Personal eliminado.');
    }
